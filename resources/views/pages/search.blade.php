...
<div class="row container" id="wrapper">
    <div class="halim-panel-filter">
       <div class="panel-heading">
          <div class="row">
             <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span>Kết quả tìm kiếm cho từ khoá » <span class="breadcrumb_last" aria-current="page">{{ $keywords }}</span></span></span></div>
             </div>
          </div>
       </div>
    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
       <section>
         ...
         @foreach($search_movie as $key => $mov)
         ...
         @endforeach
          ...
          <div class="text-center">
             ...
             {!! $search_movie->links("pagination::bootstrap-4") !!}
